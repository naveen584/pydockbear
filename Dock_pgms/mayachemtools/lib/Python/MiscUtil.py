...
__all__ = ["CheckFileExt", "CheckTextValue", "DoesSMILESFileContainTitleLine", "GetExamplesTextFromDocOptText", "GetMayaChemToolsLibDataPath", "GetTextLinesWords", "GetWallClockAndProcessorTime", "GetFormattedElapsedTime", "ParseFileName", "PrintError", "PrintInfo", "PrintWarning",  "ProcessOptionInfileParameters", "ProcessOptionOutfileParameters", "ValidateOptionsDistinctFileNames", "ValidateOptionFileExt", "ValidateOptionFilePath", "ValidateOptionNumberValue", "ValidateOptionNumberValues", "ValidateOptionsOutputFileOverwrite", "ValidateOptionTextValue"]
...
def GetTextLinesWords(TextFilePath, Delimiter, QuoteChar, HeaderLinePresent):
