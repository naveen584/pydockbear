    ...
    try:
        ...
        for item in directory:
            if item.endswith('_bcc.mol2'):
                ...
                cmd1 = "sander -O -i sander_min1.in -o sander_min.out -p complex_{0}.leap.prm -c complex_{0}.leap.crd -r complex_{0}.min1.crd".format(item)
                cmd2 = "sander -O -i sander_md_vacuo.in -o sander_mdVacuo.out -p complex_{0}.leap.prm -c complex_{0}.min1.crd -ref complex_{0}.min1.crd -r complex_{0}.MDvacuo.crd -x complex_{0}.MDvacuo.mdcrd".format(item)
                cmd3 = "sander -O -i sander_min2.in -o sander_min2.out -p complex_{0}.leap.prm -c complex_{0}.MDvacuo.crd -r complex_{0}.min2.crd".format(item)
